...
5. If litespeed plugin was installed, expect to have an issue. try to install again the litespeed and turn off the cache and purge all and install again the sepahinite
accelerator plugin
6. Incase not working, delete the (litespeed folder, advanced-cache.php and seraphinite-accelerator (inside cache folder) and begin start wizard in settings page
<script> 
